...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | YASVANTHIKA";
...
var typed = new Typed(".typing-text", {
    strings: ["frontend development", "Coading","Machine Learning", "Web Development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
const projectsData = [
    {
        ...
        image: "project1",
        links: {
            view: "http://example.com/project1",
            code: "http://github.com/example/project1"
        },
        category: "web"
    },
    {
        ...
        image: "project2",
        links: {
            view: "", // Empty view link
            code: "http://github.com/example/project2"
        },
        category: "web"
    },
